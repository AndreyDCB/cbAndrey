...
class AnalizPODRWidget extends StatefulWidget {
  const AnalizPODRWidget({Key key}) : super(key: key);

  @override
  _AnalizPODRWidgetState createState() => _AnalizPODRWidgetState();
}

class _AnalizPODRWidgetState extends State<AnalizPODRWidget> {
  @override
