...
class DOBAVvacWidget extends StatefulWidget {
  const DOBAVvacWidget({Key key}) : super(key: key);

  @override
  _DOBAVvacWidgetState createState() => _DOBAVvacWidgetState();
}

class _DOBAVvacWidgetState extends State<DOBAVvacWidget> {
