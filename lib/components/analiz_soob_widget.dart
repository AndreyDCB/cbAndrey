...
class AnalizSoobWidget extends StatefulWidget {
  const AnalizSoobWidget({Key key}) : super(key: key);

  @override
  _AnalizSoobWidgetState createState() => _AnalizSoobWidgetState();
}

class _AnalizSoobWidgetState extends State<AnalizSoobWidget> {
  @override
