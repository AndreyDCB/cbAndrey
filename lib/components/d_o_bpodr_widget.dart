...
class DOBpodrWidget extends StatefulWidget {
  const DOBpodrWidget({Key key}) : super(key: key);

  @override
  _DOBpodrWidgetState createState() => _DOBpodrWidgetState();
}

class _DOBpodrWidgetState extends State<DOBpodrWidget> {
            ...
            children: [
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Кратко напишите что нужно сделать',
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  obscureText: false,
                  decoration: InputDecoration(
                    hintText: 'Ссылка на ТЗ или приложение',
                    hintStyle: FlutterFlowTheme.bodyText1,
                    enabledBorder: UnderlineInputBorder(
                      borderSide: BorderSide(
                        color: Color(0x00000000),
