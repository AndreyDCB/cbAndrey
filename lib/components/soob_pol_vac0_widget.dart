...
class SoobPolVac0Widget extends StatefulWidget {
  const SoobPolVac0Widget({Key key}) : super(key: key);

  @override
  _SoobPolVac0WidgetState createState() => _SoobPolVac0WidgetState();
}

class _SoobPolVac0WidgetState extends State<SoobPolVac0Widget> {
  @override
