...
class UslugaSoobWidget extends StatefulWidget {
  const UslugaSoobWidget({Key key}) : super(key: key);

  @override
  _UslugaSoobWidgetState createState() => _UslugaSoobWidgetState();
}

class _UslugaSoobWidgetState extends State<UslugaSoobWidget> {
  @override
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Добрый. На какой адрес электронной почты выслать?',
                                        style:
                                            FlutterFlowTheme.bodyText1.override(
                                          fontFamily: 'Poppins',
                                          fontSize: 12,
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Добрый день. Прошу прислоать презентация услуги или ссылку на сайт',
                                        style:
                                            FlutterFlowTheme.bodyText1.override(
                                          fontFamily: 'Poppins',
                                          fontSize: 12,
