...
class SoobPolVacWidget extends StatefulWidget {
  const SoobPolVacWidget({Key key}) : super(key: key);

  @override
  _SoobPolVacWidgetState createState() => _SoobPolVacWidgetState();
}

class _SoobPolVacWidgetState extends State<SoobPolVacWidget> {
  @override
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Добрый день. Мне удалось согласовать на данную позицию оклад 80 000р. Собеседование назначено на 17-00 на завтра. Звонить по контактам что указаны в профиле? ',
                                  style: FlutterFlowTheme.bodyText1.override(
                                    fontFamily: 'Poppins',
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Text(
                                                'Добрый день. Оклад на данную вакан...',
                                      ...
                                      Text(
                                        'Добрый день. Я не готов к трудоуствойству за 70 000. Это моя текущая ЗП. Я рассматриваю вакансию от 80 000р.',
                                        style:
                                            FlutterFlowTheme.bodyText1.override(
                                          fontFamily: 'Poppins',
                                          fontSize: 12,
