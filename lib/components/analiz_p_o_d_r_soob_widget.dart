...
class AnalizPODRSoobWidget extends StatefulWidget {
  const AnalizPODRSoobWidget({Key key}) : super(key: key);

  @override
  _AnalizPODRSoobWidgetState createState() => _AnalizPODRSoobWidgetState();
}

class _AnalizPODRSoobWidgetState extends State<AnalizPODRSoobWidget> {
  @override
