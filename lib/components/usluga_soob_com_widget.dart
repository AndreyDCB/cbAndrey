...
class UslugaSoobComWidget extends StatefulWidget {
  const UslugaSoobComWidget({Key key}) : super(key: key);

  @override
  _UslugaSoobComWidgetState createState() => _UslugaSoobComWidgetState();
}

class _UslugaSoobComWidgetState extends State<UslugaSoobComWidget> {
  @override
