...
class VideoOpisWidget extends StatefulWidget {
  const VideoOpisWidget({Key key}) : super(key: key);

  @override
  _VideoOpisWidgetState createState() => _VideoOpisWidgetState();
}

class _VideoOpisWidgetState extends State<VideoOpisWidget> {
  @override
