...
class PodrabSoobOTCWidget extends StatefulWidget {
  const PodrabSoobOTCWidget({Key key}) : super(key: key);

  @override
  _PodrabSoobOTCWidgetState createState() => _PodrabSoobOTCWidgetState();
}

class _PodrabSoobOTCWidgetState extends State<PodrabSoobOTCWidget> {
  @override
