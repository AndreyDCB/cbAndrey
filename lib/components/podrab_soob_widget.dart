...
class PodrabSoobWidget extends StatefulWidget {
  const PodrabSoobWidget({Key key}) : super(key: key);

  @override
  _PodrabSoobWidgetState createState() => _PodrabSoobWidgetState();
}

class _PodrabSoobWidgetState extends State<PodrabSoobWidget> {
  @override
