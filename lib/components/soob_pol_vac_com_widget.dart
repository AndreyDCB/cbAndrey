...
class SoobPolVacComWidget extends StatefulWidget {
  const SoobPolVacComWidget({Key key}) : super(key: key);

  @override
  _SoobPolVacComWidgetState createState() => _SoobPolVacComWidgetState();
}

class _SoobPolVacComWidgetState extends State<SoobPolVacComWidget> {
  @override
