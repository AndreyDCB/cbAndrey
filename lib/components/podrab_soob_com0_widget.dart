...
class PodrabSoobCom0Widget extends StatefulWidget {
  const PodrabSoobCom0Widget({Key key}) : super(key: key);

  @override
  _PodrabSoobCom0WidgetState createState() => _PodrabSoobCom0WidgetState();
}

class _PodrabSoobCom0WidgetState extends State<PodrabSoobCom0Widget> {
  @override
